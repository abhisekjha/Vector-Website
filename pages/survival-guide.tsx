      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute top-40 right-20 w-24 h-24 bg-green-500/10 rounded-full animate-pulse animate-delay-1000" />
            <div className="absolute bottom-20 left-1/3 w-40 h-40 bg-purple-500/10 rounded-full animate-pulse animate-delay-2000" />
          </div>
          
          <Container className="relative py-20">
            <div className="text-center max-w-4xl mx-auto">
              <div className="mb-6">
                <span className="inline-block px-4 py-2 bg-[#D8FF3D] text-black text-sm font-semibold playfair-display-600 rounded-full">
                  SURVIVAL GUIDE
                </span>
              </div>
              ...
              <h1 className="text-5xl md:text-7xl font-bold playfair-display-600 mb-6 leading-tight">
                ...
                <br />
                <span className="text-[#D8FF3D]">Survival Guide</span>
              </h1>
              
              <div className="mb-8">
                <p className="text-2xl playfair-display-500 text-white/90 mb-2">Direction. Magnitude. ROI.</p>
                <p className="text-lg playfair-display-400 text-white/70 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a 
                  href="#download" 
                  className="inline-flex items-center gap-2 border border-white/20 bg-white/10 backdrop-blur px-8 py-4 rounded-full text-lg font-semibold playfair-display-600 hover:bg-white/20 transition-colors duration-200"
                >
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-white/10 rounded-2xl p-6">
                  ...
                  <p className="playfair-display-400 text-white/80">
                ...
                <div className="bg-white/10 rounded-2xl p-6">
                  ...
                  <p className="playfair-display-400 text-white/80">
                    Questions? Reach out to <a href="mailto:hello@vector.ai" className="text-[#D8FF3D] hover:underline">hello@vector.ai</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 rounded-3xl p-8 mb-8">
                <div className="text-center mb-8">
                  <div className="text-6xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">20-25%</div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-3 playfair-display-400 text-white/80">
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 playfair-display-400 text-white/80">
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#D8FF3D] rounded-full mt-2 flex-shrink-0" />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Workflow className="h-8 w-8 text-[#D8FF3D]" />
                ...
                <div className="bg-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Shield className="h-8 w-8 text-[#D8FF3D]" />
                ...
                <div className="bg-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Settings className="h-8 w-8 text-[#D8FF3D]" />
                ...
                <div className="bg-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Eye className="h-8 w-8 text-[#D8FF3D]" />
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                <div className="bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2xl p-6 text-center">
                  ...
                  <div className="text-2xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">↑</div>
                  <p className="text-sm playfair-display-400 text-white/80">Accrual Accuracy</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl p-6 text-center">
                  ...
                  <div className="text-2xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">↑</div>
                  <p className="text-sm playfair-display-400 text-white/80">Audit Pass Rate</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-6 text-center">
                  ...
                  <div className="text-2xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">↑</div>
                  <p className="text-sm playfair-display-400 text-white/80">Deduction Recovery</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-pink-500/20 to-red-500/20 rounded-2xl p-6 text-center">
                  ...
                  <div className="text-2xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">↓</div>
                  <p className="text-sm playfair-display-400 text-white/80">Cycle Time</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-2xl p-6 text-center">
                  ...
                  <div className="text-2xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">↑</div>
                  <p className="text-sm playfair-display-400 text-white/80">Promo ROI</p>
                </div>
              </div>
            </div>
          </Container>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="bg-white/10 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 bg-[#D8FF3D]/20 rounded-lg">
                        {agent.icon}
                      </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        <h4 className="text-sm font-semibold playfair-display-600 text-[#D8FF3D] mb-1">Purpose</h4>
                        <p className="text-sm playfair-display-400 text-white/80">{agent.purpose}</p>
                      </div>
                      <div>
                        <h4 className="text-sm font-semibold playfair-display-600 text-[#D8FF3D] mb-1">Triggers</h4>
                        <p className="text-sm playfair-display-400 text-white/80">{agent.triggers}</p>
                      </div>
                      <div>
                        <h4 className="text-sm font-semibold playfair-display-600 text-[#D8FF3D] mb-1">Actions</h4>
                        <p className="text-sm playfair-display-400 text-white/80">{agent.actions}</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="space-y-8">
                <div className="bg-white/10 rounded-2xl p-6">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 bg-[#D8FF3D] text-black rounded-full flex items-center justify-center font-bold playfair-display-600">
                      1-2
                    </div>
        ...
        <section className="py-16 bg-white/5">
          <Container>
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-[#D8FF3D]/20 to-blue-500/20 rounded-3xl p-8">
                <div className="grid md:grid-cols-3 gap-8 text-center">
                  <div>
                    <div className="text-4xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">$100M</div>
                    <p className="playfair-display-400 text-white/80">Trade Base</p>
                    <p className="text-sm playfair-display-400 text-white/60 mt-1">+3-5% uplift target</p>
                  </div>
                  
                  <div>
                    <div className="text-4xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">5% → 2%</div>
                    <p className="playfair-display-400 text-white/80">Accrual Delta</p>
                    <p className="text-sm playfair-display-400 text-white/60 mt-1">Improved accuracy</p>
                  </div>
                  
                  <div>
                    <div className="text-4xl font-bold playfair-display-600 text-[#D8FF3D] mb-2">+10-15%</div>
                    <p className="playfair-display-400 text-white/80">Deduction Recovery</p>
                    <p className="text-sm playfair-display-400 text-white/60 mt-1">Automated processes</p>
                  </div>
                </div>
                
                <div className="mt-8 text-center">
                  <p className="text-lg playfair-display-500 text-white/90">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-[#D8FF3D] text-black rounded-full flex items-center justify-center font-bold playfair-display-600 text-sm">
                            {i + 1}
                          </div>
                          <span className="playfair-display-400 text-white/80">{step}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-white/5 rounded-xl p-4">
                        <h4 className="font-semibold playfair-display-600 text-[#D8FF3D] mb-2">Ledger</h4>
                        <p className="text-sm playfair-display-400 text-white/80">Tamper-evident events with as-of reconstruction</p>
                      </div>
                      <div className="bg-white/5 rounded-xl p-4">
                        <h4 className="font-semibold playfair-display-600 text-[#D8FF3D] mb-2">OPA Policies</h4>
                        <p className="text-sm playfair-display-400 text-white/80">Approve/deny with reasons and override trails</p>
                      </div>
                      <div className="bg-white/5 rounded-xl p-4">
                        <h4 className="font-semibold playfair-display-600 text-[#D8FF3D] mb-2">Lineage</h4>
                        <p className="text-sm playfair-display-400 text-white/80">Complete feed → model → decision → P&L traceability</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={i} className="bg-white/10 rounded-xl p-3 text-center">
                        <span className="playfair-display-500 text-white/90">{system}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[#D8FF3D]" />
                      <span className="playfair-display-400 text-white/80">Real-time sync with error handling</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[#D8FF3D]" />
                      <span className="playfair-display-400 text-white/80">SLA monitoring and alerts</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[#D8FF3D]" />
                      <span className="playfair-display-400 text-white/80">Schema diff detection</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[#D8FF3D]" />
                      <span className="playfair-display-400 text-white/80">Safe replay and backfill</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[#D8FF3D]" />
                      <span className="playfair-display-400 text-white/80">OpenLineage event tracking</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={i} className="bg-white/10 rounded-2xl p-6 text-center">
                    <div className="text-[#D8FF3D] mb-4 flex justify-center">
                      {item.icon}
                    </div>
                    <h3 className="text-lg font-semibold playfair-display-600 mb-2">{item.title}</h3>
                    <p className="text-sm playfair-display-400 text-white/80">{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="bg-white/10 rounded-2xl p-6">
                    ...
                    <p className="playfair-display-400 text-white/80">{faq.a}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* CTA Section */}
        <section className="py-16 bg-gradient-to-r from-[#D8FF3D]/20 to-blue-500/20">
          <Container>
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-4xl font-semibold playfair-display-600 mb-6">
                Ready to Transform Your Trade Operations?
              </h2>
              <p className="text-xl playfair-display-400 text-white/80 mb-8">
